...
contract("Marketplace", function (accounts) {
  ...
  it("should list nfts", async function () {
    ...
    await tracker.get();
    let txn = await marketplace.listNFT(nftContract, tokenID1, '1000000000000000000', TOMORROW, IN_FIVE_DAYS, {from: TOKEN_OWNER, value: '1000000000000000'});
  ...
  it("should validate rentals", async function () {
    ...
    console.log(listingFee, ether("1"));
    await expectRevert(
